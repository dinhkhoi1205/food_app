...
public class dessert_listview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<food_items_listData> dessertItemsListDataList = new ArrayList<food_items_listData>();
        ...
        recyclerView.setAdapter(new food_Adapter(this,dessertItemsListDataList));
    }
}